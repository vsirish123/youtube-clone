...
const seedVideos = async () => {
  try {
    ...
    for (let channelIndex = 1; channelIndex <= 10; channelIndex++) {
      const channelId = new mongoose.Types.ObjectId(
        `65a1000000000000000000${channelIndex.toString().padStart(2, "0")}`
      );
...
👍 Like, Share & Subscribe for more ${category} content!
            `,
            videoUrl:
